export const STRATEGY='selective-deep-research-v11';
...
export const BULL_LEVERAGED=new Set(['TQQQ','UPRO','SOXL','TNA']);
...
export function entryWindowOpen(time){const{hour,minute}=etParts(time),m=hour*60+minute;return m>=570&&m<950}
