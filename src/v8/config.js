export const STRATEGY='intraday-profitability-v8.4';
...
export function entryWindowOpen(time){const{hour,minute}=etParts(time),m=hour*60+minute;return m>=575&&m<=950}
